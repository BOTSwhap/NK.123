...
exports.smsg = (conn, m, hasParent) => {
  ...
  if (m.message) {
    ...
    if (m.quoted) {
      ...
      if (m.quoted.url) m.quoted.download = (type = 'buffer') => conn.downloadAndSaveMediaMessage(vM, type)
      /**
    ...
    if (m.msg.url) m.download = (type = 'buffer') => conn.downloadAndSaveMediaMessage(m, type)
