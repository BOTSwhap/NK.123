...
async function writeExifImg (media, metadata) {
    ...
    if (metadata.packname || metadata.author) {
        ...
        const json = { "sticker-pack-id": `https://wa.me/51994386439?text=hola`, "sticker-pack-name": metadata.packname, "sticker-pack-publisher": metadata.author, "emojis": metadata.categories ? metadata.categories : [""] }
...
module.exports = { imageToWebp, videoToWebp, writeExifImg, writeExifVid, convertSticker }